...
const interviewHubRoutes = academies.flatMap((academy) => [`/interview-hub/${academy.slug}/`, ...interviewHubGuides.map((guide) => `/interview-hub/${academy.slug}/${guide.slug}/`)]);
...
const assessmentCenterRoutes = academies.flatMap((academy) => [`/assessment-center/${academy.slug}/`, ...assessmentCenterGuides.map((guide) => `/assessment-center/${academy.slug}/${guide.slug}/`)]);
...
const knowledgeGraphRoutes = academies.flatMap((academy) => [`/knowledge-graph/${academy.slug}/`, ...knowledgeGraphGuides.map((guide) => `/knowledge-graph/${academy.slug}/${guide.slug}/`)]);
