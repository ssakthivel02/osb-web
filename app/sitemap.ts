...
const coreRoutes = [
  '', '/academies/', '/career/', '/resources/', '/operations/', '/governance/', '/delivery/', '/leadership/', '/workshops/', '/interview/', '/runbooks/', '/patterns/', '/architecture/', '/architecture-explorer/', '/certifications/', '/learning-plans/', '/assessments/', '/downloads/', '/projects/', '/portfolio/', '/troubleshooting/', '/checklists/', '/labs/', '/interactive-labs/', '/scenarios/', '/commands/', '/glossary/', '/knowledge/', '/ai-assistant/', '/ai-coach/', '/case-studies/', '/operations-dashboard/', '/security-playbooks/', '/finops-center/', '/architecture-diagrams/', '/infrastructure-templates/', '/architecture-studio/', '/template-library/', '/interview-simulator/', '/enterprise-documentation/', '/learning-paths/', '/skill-matrix/', '/release-readiness/', '/service-catalogue/', '/observability-center/', '/disaster-recovery/', '/compliance-center/', '/platform-operations/', '/tracks/', '/tracks/devops/', '/tracks/azure-cloud/', '/tracks/platform-engineering/', '/tracks/cloud-security/',
...
const architectureExplorerRoutes = academies.flatMap((academy) => [`/architecture-explorer/${academy.slug}/`, ...architectureExplorerGuides.map((guide) => `/architecture-explorer/${academy.slug}/${guide.slug}/`)]);
...
const interactiveLabRoutes = academies.flatMap((academy) => [`/interactive-labs/${academy.slug}/`, ...interactiveLabGuides.map((guide) => `/interactive-labs/${academy.slug}/${guide.slug}/`)]);
...
const aiCoachRoutes = academies.flatMap((academy) => [`/ai-coach/${academy.slug}/`, ...aiCoachGuides.map((guide) => `/ai-coach/${academy.slug}/${guide.slug}/`)]);
