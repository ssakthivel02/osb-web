...
const expected={
  records:277,tracks:19,populatedTracks:14,paths:2,sources:184,relationships:1094,
  relationshipTypeBreakdown:{PREREQUISITE_OF:492,CROSS_LINK:602},
  typeBreakdown:{ASSESSMENT:38,CAPSTONE:2,DEEP_DIVE:33,EASY_LEARN:32,INTERVIEW:34,LAB:33,LESSON:67,TROUBLESHOOTING:35,VISUAL_SPEC:3}
};
...
for(const [trackId,label] of [
  ...
  ['OSB-TRACK-ARCH','Infrastructure Architecture / SRE / Operations']
...
const result={
  ...
  expansionBatch:'BATCH-020R16-ARCH-SRE',errors
};
